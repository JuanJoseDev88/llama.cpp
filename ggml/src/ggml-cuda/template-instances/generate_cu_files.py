...
# types whose MMQ kernels are plain SIMT integer code (no NVIDIA-only instructions);
# they compile for HIP as well, so the generated instances stay un-gated
TYPES_MMQ_HIP_OK = [
    "GGML_TYPE_PTQ1_0",
]
...
for type in TYPES_MMQ:
    with open(f"mmq-instance-{get_short_name(type)}.cu", "w") as f:
        source = SOURCE_MMQ if type in TYPES_MMQ_HIP_OK else SOURCE_MMQ_CUDA_ONLY
